...
_Guião gerado a partir do deck. O reveal.js também mostra estas notas na **vista de orador**: abre o deck e carrega em **`S`** (janela com nota + próximo slide + cronómetro)._

## Como usar

- **Não ler à letra.** Cada bloco é o *essencial a dizer* + as armadilhas a evitar. Falar sobre, não recitar.
- **Ritmo flexível.** Conforme o aquecimento (deck «Antes de começar»): sala sénior → correr nos Fundamentos; mais júnior → demorar. Diz-me a duração total e aperto os tempos por secção.
- **Regras da casa:** erro/aviso sempre em **azeitona, nunca vermelho**; tom adulto, sem floreados; os exemplos fora da saúde são de propósito (público informático).
- **Sandboxes:** EX-1 (SQL que mente) em «construir com a GenAI»; EX-2 (extrator) e EX-3/4/5 (embeddings/RAG) em «construir para a GenAI».
...
**21. Duas relações entre uma coisa e a outra**  ·  <sub>GenAI e engenharia de dados</sub>
...
**22. "Já não é preciso escrever SQL — os LLMs escrevem-no"**  ·  <sub>O mito</sub>
...
**23. "Tempo médio até à primeira consulta"**  ·  <sub>O SQL que mente · linhas em falta</sub>
...
**24. "Armazéns que nunca expediram nada"**  ·  <sub>O SQL que mente · NOT IN + NULL</sub>
...
**25. "Qual o produto mais vendido?"**  ·  <sub>O SQL que mente · definição ambígua</sub>
...
**26. "Mostra-me os utilizadores ativos"**  ·  <sub>O SQL que mente · definição de negócio</sub>
...
**27. "Doentes com glicemia alta"**  ·  <sub>O SQL que mente · unidades e limiar</sub>
...
**28. "Quantas encomendas este mês?"**  ·  <sub>O SQL que mente · soft delete</sub>
...
**29. "Os 3 melhores vendedores do trimestre"**  ·  <sub>O SQL que mente · empates no top-N</sub>
...
**30. Porque é que isto é pior do que um erro de execução**  ·  <sub>O SQL que mente · síntese</sub>
...
**31. Onde a GenAI acelera de facto**  ·  <sub>A GenAI ao serviço do engenheiro de dados</sub>
...
**32. O passo crítico: ligar a pergunta ao schema**  ·  <sub>A GenAI ao serviço do engenheiro · porque o NL2SQL falha</sub>
...
**33. Traduzir Oracle → BigQuery não é trocar funções**  ·  <sub>A GenAI ao serviço do engenheiro · migração de dialetos</sub>
...
**34. Documentar o data warehouse que ninguém documentou**  ·  <sub>A GenAI ao serviço do engenheiro · catalogação</sub>
...
**35. O erro que passa em todas as regras**  ·  <sub>A GenAI ao serviço do engenheiro · qualidade semântica</sub>
...
**36. Estes copilotos já vêm nas plataformas de dados**  ·  <sub>A GenAI ao serviço do engenheiro · nas plataformas</sub>
...
**37. O valor mudou de lugar**  ·  <sub>A GenAI ao serviço do engenheiro · em síntese</sub>
...
**38. O T do ETL pode ser um LLM**  ·  <sub>Construir para a GenAI · LLM-como-ETL</sub>
...
**39. Dez fontes sujas, dez extrações**  ·  <sub>Construir para a GenAI · o roteiro</sub>
...
**40. Inferir o que está implícito — sem inventar o que falta**  ·  <sub>Exemplo 2 · suporte</sub>
...
**41. O número está certo — o qualificador é que não**  ·  <sub>Exemplo 3 · jurídico</sub>
...
**42. Texto sujo, e a vírgula decimal portuguesa**  ·  <sub>Exemplo 4 · recibo (OCR)</sub>
...
**43. Sintetizar factos que o texto não nomeia**  ·  <sub>Exemplo 5 · CV</sub>
...
**44. Parsing de morada, com campos que podem faltar**  ·  <sub>Exemplo 6 · morada</sub>
...
**45. Sentimento não é um número — é por aspeto**  ·  <sub>Exemplo 7 · review</sub>
...
**46. O caso em que o regex bate o LLM**  ·  <sub>Exemplo 8 · linha de log</sub>
...
**47. Documento longo: o que cabe, e mantém-se consistente?**  ·  <sub>Exemplo 9 · carta de alta</sub>
...
**48. Muitos tipos numa frase — o trabalho passa para a especificação**  ·  <sub>Exemplo 10 · anúncio imobiliário</sub>
...
**49. "Sem X" significa ausência de X, não a sua presença**  ·  <sub>Falha 1 · negação</sub>
...
**50. Uma só forma canónica — mas quem a define?**  ·  <sub>Falha 2 · normalização</sub>
...
**51. Preencher o que o texto não diz**  ·  <sub>Falha 3 · alucinação</sub>
...
**52. A mesma entrada, duas saídas**  ·  <sub>Falha 4 · não-determinismo</sub>
...
**53. Regra determinística ou LLM?**  ·  <sub>Construir para a GenAI · o critério</sub>
...
**54. O schema é um contrato, não uma sugestão**  ·  <sub>Construir para a GenAI · a resposta de engenharia · 1/2</sub>
...
**55. O LLM exige o contrato de dados, não o dispensa**  ·  <sub>Construir para a GenAI · a resposta de engenharia · 2/2</sub>
...
**56. Do texto ao vetor, em cinco passos**  ·  <sub>A cadeia</sub>
...
**57. O texto vira tokens — as peças que o modelo processa**  ·  <sub>Passo 1 · Tokenização</sub>
...
**58. Um vetor por token — mas estático**  ·  <sub>Passo 2 · Matriz de embeddings</sub>
...
**59. A mesma palavra, dois vetores**  ·  <sub>Passo 3 · Contextualização</sub>
...
**60. A média dilui**  ·  <sub>Passo 4 · Pooling</sub>
...
**61. Porque é que perto = parecido?**  ·  <sub>Passo 5 · Treino</sub>
...
**62. Para a engenharia, o vetor é mais um dado**  ·  <sub>Embeddings · consequências de engenharia</sub>
...
**63. O que distingue os dois**  ·  <sub>Embeddings · síntese</sub>
...
**64. Disfarçado de IA**  ·  <sub>O sentimento de 2026</sub>
...
**65. O LLM não conhece os seus dados**  ·  <sub>RAG · o problema que resolve</sub>
...
**66. Seis caixas — só a última é "IA"**  ·  <sub>RAG · a pipeline</sub>
...
**67. Preparar antes, responder na hora**  ·  <sub>RAG · dois momentos</sub>
...
**68. Onde os dados vivem — e em que estado chegam**  ·  <sub>RAG · ingestão</sub>
...
**69. Garbage in, garbage out — começa no PDF**  ·  <sub>RAG · parsing</sub>
...
**70. O chunk é a unidade de tudo**  ·  <sub>RAG · chunking</sub>
...
**71. Tamanho fixo — o corte cego**  ·  <sub>Chunking · estratégia 1/5</sub>
...
**72. Com overlap — a janela que desliza**  ·  <sub>Chunking · estratégia 2/5</sub>
...
**73. Estrutural — cortar onde o documento já corta**  ·  <sub>Chunking · estratégia 3/5</sub>
...
**74. Semântico — cortar onde o tema muda**  ·  <sub>Chunking · estratégia 4/5</sub>
...
**75. Layout-aware — a tabela não se parte**  ·  <sub>Chunking · estratégia 5/5</sub>
...
**76. Mesma pergunta, mesmo modelo, resultado oposto**  ·  <sub>Chunking · o caso que torna o ponto inegável</sub>
...
**77. Pequeno ou grande: um compromisso, não uma receita**  ·  <sub>Chunking · o compromisso</sub>
...
**78. O que parte um RAG são problemas de dados**  ·  <sub>RAG · produção</sub>
...
**79. Estocástico vs determinístico**  ·  <sub>Limites e cuidados · 1</sub>
...
**80. Corrupção silenciosa**  ·  <sub>Limites e cuidados · 2</sub>
...
**81. Custo e latência: um LLM sobre milhões de linhas**  ·  <sub>Limites e cuidados · 3</sub>
...
**82. Quando NÃO usar um LLM**  ·  <sub>Limites e cuidados · 4</sub>
...
**83. De escrever pipelines a desenhar ecossistemas**  ·  <sub>Síntese · o papel</sub>
...
**84. Ler e validar passou a valer mais**  ·  <sub>Síntese · o que passa a distinguir</sub>
...
**85. O próximo passo: pipelines que se auto-curam**  ·  <sub>A seguir</sub>
